...
router.post('/', verifyToken, requireRole(['Admin', 'Technician']), sparepartController.createSparepart);
...
router.put('/:id', verifyToken, requireRole(['Admin', 'Technician']), sparepartController.updateSparepart);
